...
public class GraphData {
    ...
    public Object[] getHeadObject(){
        ...
        if(this.index<this.graphData.size()){
    ...
    public ArrayList<Object[]> sortGraphDataChronologically(){

        Collections.sort(this.graphData, new Comparator<Object[]>() {
            @Override
            public int compare(Object[] o1, Object[] o2) {
                Long epochTimeFromFirstObject=Long.parseLong(o1[0].toString());
                Long epochTimeFromSecondObject=Long.parseLong(o2[0].toString());
                return epochTimeFromFirstObject.compareTo(epochTimeFromSecondObject);
            }
        });
    ...
    public Object[] getHeadObjectInChronologicalOrder(){
        sortGraphDataChronologically();
