...
import SpeedChart from './ChartComponent';
...
// inline styles should move to css file
function App() {
   ...
   const[graphData, setGraphData] = useState([]);
    ...
    useEffect(() => {
        ...
        mySocket.onMessage((jsonMessage, args)=>{
            ...
            // updated the code as we are dependent on the previous graphdata,
           // this syntax is preferred as react schedules state update
            setGraphData((graphData) =>{
               return [...graphData, jsonMessage]
            }  );
